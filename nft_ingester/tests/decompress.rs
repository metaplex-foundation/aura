...
mod tests {
    ...
    async fn test_decompress_ideal_flow() {
        ...
        // END OF BBLG PROCESSOR

        // MPLX PROCESSOR

        let db_client = Arc::new(DBClient{pool: env.pg_env.pool.clone()});
        ...
        let nft_created_slot = 242856151;
    ...
    async fn test_decompress_first_mint_then_decompress_diff_slots() {
        ...
        // in this test this slot is greater then decompress slot
        let nft_created_slot = 252856151;
