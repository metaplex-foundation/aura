...
export INGESTER_ROCKS_DB_PATH_CONTAINER="/rocks-db/rocksdb-data"
export INGESTER_ROCKS_BACKUP_URL="127.0.0.1:3051/snapshot"
export INGESTER_ROCKS_BACKUP_ARCHIVES_DIR="/rocks-db/_rocks_backup_archives"
export INGESTER_ROCKS_BACKUP_DIR="/rocks-db/_rocksdb_backup"
export INGESTER_ROCKS_FLUSH_BEFORE_BACKUP=true
export INGESTER_ROCKS_INTERVAL_IN_SECONDS=7200
export INGESTER_ROCKS_DB_V0_PATH="/rocks-db/rocksdb-data-v0"

export APP_DATABASE_URL="postgres://solana:solana@localhost:5432/solana"
export APP_SERVER_PORT=9090
export APP_METRICS_PORT=8125
export APP_METRICS_HOST="localhost"
export APP_ARCHIVES_DIR="/rocks-db/_rocks_backup_archives"
...
cargo run --package nft_ingester --bin rocks_migrator
