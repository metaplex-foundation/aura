...
impl<'a> OffChainData<'a> {
  ...
  pub fn storage_mutability(&self) -> StorageMutability {
    ...
    unsafe { self._tab.get::<StorageMutability>(OffChainData::VT_STORAGE_MUTABILITY, Some(StorageMutability::Immutable)).unwrap()}
  }
  #[inline]
  pub fn url(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OffChainData::VT_URL, None)}
  }
  #[inline]
  pub fn metadata(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OffChainData::VT_METADATA, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for OffChainData<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<StorageMutability>("storage_mutability", Self::VT_STORAGE_MUTABILITY, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> OffChainDataBuilder<'a, 'b, A> {
  ...
  pub fn add_storage_mutability(&mut self, storage_mutability: StorageMutability) {
    self.fbb_.push_slot::<StorageMutability>(OffChainData::VT_STORAGE_MUTABILITY, storage_mutability, StorageMutability::Immutable);
  }
  #[inline]
  ...
  pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OffChainData::VT_METADATA, metadata);
  }
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> OffChainDataBuilder<'a, 'b, A> {
...
pub fn root_as_off_chain_data(buf: &[u8]) -> Result<OffChainData, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_off_chain_data(buf: &[u8]) -> Result<OffChainData, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_off_chain_data_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<OffChainData<'a>>) {
